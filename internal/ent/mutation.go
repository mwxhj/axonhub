...
const (
	...
	TypeChannel                  = "Channel"
	TypeChannelCredentialRef     = "ChannelCredentialRef"
	...
	TypeThread                   = "Thread"
	TypeTrace                    = "Trace"
	TypeUpstreamCredential       = "UpstreamCredential"
...
func (m *ChannelMutation) AddCredentialRefIDs(ids ...int) {
	if m.credential_refs == nil {
		m.credential_refs = make(map[int]struct{})
	}
	for i := range ids {
		m.credential_refs[ids[i]] = struct{}{}
	}
}

// ClearCredentialRefs clears the "credential_refs" edge to the ChannelCredentialRef entity.
func (m *ChannelMutation) ClearCredentialRefs() {
	m.clearedcredential_refs = true
}

// CredentialRefsCleared reports if the "credential_refs" edge to the ChannelCredentialRef entity was cleared.
func (m *ChannelMutation) CredentialRefsCleared() bool {
	return m.clearedcredential_refs
}

// RemoveCredentialRefIDs removes the "credential_refs" edge to the ChannelCredentialRef entity by IDs.
func (m *ChannelMutation) RemoveCredentialRefIDs(ids ...int) {
	if m.removedcredential_refs == nil {
		m.removedcredential_refs = make(map[int]struct{})
	}
	for i := range ids {
		delete(m.credential_refs, ids[i])
		m.removedcredential_refs[ids[i]] = struct{}{}
	}
}

// RemovedCredentialRefs returns the removed IDs of the "credential_refs" edge to the ChannelCredentialRef entity.
func (m *ChannelMutation) RemovedCredentialRefsIDs() (ids []int) {
	for id := range m.removedcredential_refs {
		ids = append(ids, id)
	}
	return
}

// CredentialRefsIDs returns the "credential_refs" edge IDs in the mutation.
func (m *ChannelMutation) CredentialRefsIDs() (ids []int) {
	for id := range m.credential_refs {
		ids = append(ids, id)
	}
	return
}

// ResetCredentialRefs resets all changes to the "credential_refs" edge.
func (m *ChannelMutation) ResetCredentialRefs() {
	m.credential_refs = nil
	m.clearedcredential_refs = false
...
func (m *ChannelMutation) AddedIDs(name string) []ent.Value {
	...
	case channel.EdgeCredentialRefs:
		ids := make([]ent.Value, 0, len(m.credential_refs))
		for id := range m.credential_refs {
			ids = append(ids, id)
		}
		return ids
...
func (m *ChannelMutation) RemovedIDs(name string) []ent.Value {
	...
	case channel.EdgeChannelModelPrices:
		...
		return ids
	case channel.EdgeCredentialRefs:
		ids := make([]ent.Value, 0, len(m.removedcredential_refs))
		for id := range m.removedcredential_refs {
			ids = append(ids, id)
		}
		return ids
...
// ChannelCredentialRefMutation represents an operation that mutates the ChannelCredentialRef nodes in the graph.
type ChannelCredentialRefMutation struct {
	config
	op                 Op
	typ                string
	id                 *int
	...
	oldValue           func(context.Context) (*ChannelCredentialRef, error)
	predicates         []predicate.ChannelCredentialRef
}

var _ ent.Mutation = (*ChannelCredentialRefMutation)(nil)

// channelcredentialrefOption allows management of the mutation configuration using functional options.
type channelcredentialrefOption func(*ChannelCredentialRefMutation)

// newChannelCredentialRefMutation creates new mutation for the ChannelCredentialRef entity.
func newChannelCredentialRefMutation(c config, op Op, opts ...channelcredentialrefOption) *ChannelCredentialRefMutation {
	m := &ChannelCredentialRefMutation{
		config:        c,
		op:            op,
		typ:           TypeChannelCredentialRef,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withChannelCredentialRefID sets the ID field of the mutation.
func withChannelCredentialRefID(id int) channelcredentialrefOption {
	return func(m *ChannelCredentialRefMutation) {
		var (
			err   error
			once  sync.Once
			value *ChannelCredentialRef
		)
		m.oldValue = func(ctx context.Context) (*ChannelCredentialRef, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().ChannelCredentialRef.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withChannelCredentialRef sets the old ChannelCredentialRef of the mutation.
func withChannelCredentialRef(node *ChannelCredentialRef) channelcredentialrefOption {
	return func(m *ChannelCredentialRefMutation) {
		m.oldValue = func(context.Context) (*ChannelCredentialRef, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m ChannelCredentialRefMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m ChannelCredentialRefMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *ChannelCredentialRefMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *ChannelCredentialRefMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().ChannelCredentialRef.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetCreatedAt sets the "created_at" field.
func (m *ChannelCredentialRefMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *ChannelCredentialRefMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the ChannelCredentialRef entity.
// If the ChannelCredentialRef object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ChannelCredentialRefMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *ChannelCredentialRefMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *ChannelCredentialRefMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *ChannelCredentialRefMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the ChannelCredentialRef entity.
// If the ChannelCredentialRef object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ChannelCredentialRefMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *ChannelCredentialRefMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// SetChannelID sets the "channel_id" field.
func (m *ChannelCredentialRefMutation) SetChannelID(i int) {
	m.channel = &i
}

// ChannelID returns the value of the "channel_id" field in the mutation.
func (m *ChannelCredentialRefMutation) ChannelID() (r int, exists bool) {
	v := m.channel
	if v == nil {
		return
	}
...
// OldChannelID returns the old "channel_id" field's value of the ChannelCredentialRef entity.
// If the ChannelCredentialRef object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ChannelCredentialRefMutation) OldChannelID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ChannelCredentialRefMutation) ResetChannelID() {
	m.channel = nil
}

// SetCredentialID sets the "credential_id" field.
func (m *ChannelCredentialRefMutation) SetCredentialID(i int) {
	m.credential = &i
}

// CredentialID returns the value of the "credential_id" field in the mutation.
func (m *ChannelCredentialRefMutation) CredentialID() (r int, exists bool) {
	v := m.credential
	if v == nil {
		return
	}
...
// OldCredentialID returns the old "credential_id" field's value of the ChannelCredentialRef entity.
// If the ChannelCredentialRef object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ChannelCredentialRefMutation) OldCredentialID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ChannelCredentialRefMutation) ResetCredentialID() {
	m.credential = nil
}

// SetEnabled sets the "enabled" field.
func (m *ChannelCredentialRefMutation) SetEnabled(b bool) {
	m.enabled = &b
}

// Enabled returns the value of the "enabled" field in the mutation.
func (m *ChannelCredentialRefMutation) Enabled() (r bool, exists bool) {
	v := m.enabled
	if v == nil {
		return
	}
...
// OldEnabled returns the old "enabled" field's value of the ChannelCredentialRef entity.
// If the ChannelCredentialRef object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ChannelCredentialRefMutation) OldEnabled(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ChannelCredentialRefMutation) ResetEnabled() {
	m.enabled = nil
}

// SetWeightOverride sets the "weight_override" field.
func (m *ChannelCredentialRefMutation) SetWeightOverride(i int) {
	m.weight_override = &i
	m.addweight_override = nil
}

// WeightOverride returns the value of the "weight_override" field in the mutation.
func (m *ChannelCredentialRefMutation) WeightOverride() (r int, exists bool) {
	v := m.weight_override
	if v == nil {
		return
	}
...
// OldWeightOverride returns the old "weight_override" field's value of the ChannelCredentialRef entity.
// If the ChannelCredentialRef object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ChannelCredentialRefMutation) OldWeightOverride(ctx context.Context) (v *int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ChannelCredentialRefMutation) AddWeightOverride(i int) {
...
func (m *ChannelCredentialRefMutation) AddedWeightOverride() (r int, exists bool) {
...
func (m *ChannelCredentialRefMutation) ClearWeightOverride() {
	m.weight_override = nil
	m.addweight_override = nil
	m.clearedFields[channelcredentialref.FieldWeightOverride] = struct{}{}
}

// WeightOverrideCleared returns if the "weight_override" field was cleared in this mutation.
func (m *ChannelCredentialRefMutation) WeightOverrideCleared() bool {
	_, ok := m.clearedFields[channelcredentialref.FieldWeightOverride]
	return ok
}

// ResetWeightOverride resets all changes to the "weight_override" field.
func (m *ChannelCredentialRefMutation) ResetWeightOverride() {
	m.weight_override = nil
	m.addweight_override = nil
	delete(m.clearedFields, channelcredentialref.FieldWeightOverride)
}

// ClearChannel clears the "channel" edge to the Channel entity.
func (m *ChannelCredentialRefMutation) ClearChannel() {
	m.clearedchannel = true
	m.clearedFields[channelcredentialref.FieldChannelID] = struct{}{}
}

// ChannelCleared reports if the "channel" edge to the Channel entity was cleared.
func (m *ChannelCredentialRefMutation) ChannelCleared() bool {
...
func (m *ChannelCredentialRefMutation) ChannelIDs() (ids []int) {
...
func (m *ChannelCredentialRefMutation) ResetChannel() {
	m.channel = nil
	m.clearedchannel = false
}

// ClearCredential clears the "credential" edge to the UpstreamCredential entity.
func (m *ChannelCredentialRefMutation) ClearCredential() {
	m.clearedcredential = true
	m.clearedFields[channelcredentialref.FieldCredentialID] = struct{}{}
}

// CredentialCleared reports if the "credential" edge to the UpstreamCredential entity was cleared.
func (m *ChannelCredentialRefMutation) CredentialCleared() bool {
...
func (m *ChannelCredentialRefMutation) CredentialIDs() (ids []int) {
...
func (m *ChannelCredentialRefMutation) ResetCredential() {
	m.credential = nil
	m.clearedcredential = false
}

// Where appends a list predicates to the ChannelCredentialRefMutation builder.
func (m *ChannelCredentialRefMutation) Where(ps ...predicate.ChannelCredentialRef) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the ChannelCredentialRefMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *ChannelCredentialRefMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.ChannelCredentialRef, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *ChannelCredentialRefMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *ChannelCredentialRefMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (ChannelCredentialRef).
func (m *ChannelCredentialRefMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *ChannelCredentialRefMutation) Fields() []string {
	fields := make([]string, 0, 6)
	if m.created_at != nil {
		fields = append(fields, channelcredentialref.FieldCreatedAt)
	}
	if m.updated_at != nil {
		fields = append(fields, channelcredentialref.FieldUpdatedAt)
	}
	if m.channel != nil {
		fields = append(fields, channelcredentialref.FieldChannelID)
	}
	if m.credential != nil {
		fields = append(fields, channelcredentialref.FieldCredentialID)
	}
	if m.enabled != nil {
		fields = append(fields, channelcredentialref.FieldEnabled)
	}
	if m.weight_override != nil {
		fields = append(fields, channelcredentialref.FieldWeightOverride)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *ChannelCredentialRefMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *ChannelCredentialRefMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case channelcredentialref.FieldCreatedAt:
		return m.OldCreatedAt(ctx)
	case channelcredentialref.FieldUpdatedAt:
	...
	return nil, fmt.Errorf("unknown ChannelCredentialRef field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ChannelCredentialRefMutation) SetField(name string, value ent.Value) error {
	switch name {
	case channelcredentialref.FieldCreatedAt:
		v, ok := value.(time.Time)
		if !ok {
	...
	return fmt.Errorf("unknown ChannelCredentialRef field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *ChannelCredentialRefMutation) AddedFields() []string {
	var fields []string
	if m.addweight_override != nil {
		fields = append(fields, channelcredentialref.FieldWeightOverride)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *ChannelCredentialRefMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case channelcredentialref.FieldWeightOverride:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ChannelCredentialRefMutation) AddField(name string, value ent.Value) error {
	switch name {
	case channelcredentialref.FieldWeightOverride:
		v, ok := value.(int)
		if !ok {
	...
	return fmt.Errorf("unknown ChannelCredentialRef numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *ChannelCredentialRefMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(channelcredentialref.FieldWeightOverride) {
		fields = append(fields, channelcredentialref.FieldWeightOverride)
	}
	return fields
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *ChannelCredentialRefMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *ChannelCredentialRefMutation) ClearField(name string) error {
	switch name {
	case channelcredentialref.FieldWeightOverride:
		m.ClearWeightOverride()
		return nil
	}
	return fmt.Errorf("unknown ChannelCredentialRef nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *ChannelCredentialRefMutation) ResetField(name string) error {
	switch name {
	case channelcredentialref.FieldCreatedAt:
		m.ResetCreatedAt()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *ChannelCredentialRefMutation) AddedEdges() []string {
	edges := make([]string, 0, 2)
	if m.channel != nil {
		edges = append(edges, channelcredentialref.EdgeChannel)
	}
	if m.credential != nil {
		edges = append(edges, channelcredentialref.EdgeCredential)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *ChannelCredentialRefMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case channelcredentialref.EdgeChannel:
		if id := m.channel; id != nil {
			return []ent.Value{*id}
		}
	case channelcredentialref.EdgeCredential:
		if id := m.credential; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *ChannelCredentialRefMutation) RemovedEdges() []string {
	edges := make([]string, 0, 2)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *ChannelCredentialRefMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *ChannelCredentialRefMutation) ClearedEdges() []string {
	edges := make([]string, 0, 2)
	if m.clearedchannel {
		edges = append(edges, channelcredentialref.EdgeChannel)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *ChannelCredentialRefMutation) EdgeCleared(name string) bool {
	switch name {
	case channelcredentialref.EdgeChannel:
		return m.clearedchannel
	case channelcredentialref.EdgeCredential:
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *ChannelCredentialRefMutation) ClearEdge(name string) error {
	switch name {
	case channelcredentialref.EdgeChannel:
		m.ClearChannel()
		return nil
	...
	return fmt.Errorf("unknown ChannelCredentialRef unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *ChannelCredentialRefMutation) ResetEdge(name string) error {
	switch name {
	case channelcredentialref.EdgeChannel:
		m.ResetChannel()
		return nil
	...
	return fmt.Errorf("unknown ChannelCredentialRef edge %s", name)
}
...
// SetCredentialID sets the "credential_id" field.
func (m *ProviderQuotaStatusMutation) SetCredentialID(i int) {
	m.credential = &i
}

// CredentialID returns the value of the "credential_id" field in the mutation.
func (m *ProviderQuotaStatusMutation) CredentialID() (r int, exists bool) {
	v := m.credential
	if v == nil {
		return
	}
...
// OldCredentialID returns the old "credential_id" field's value of the ProviderQuotaStatus entity.
// If the ProviderQuotaStatus object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ProviderQuotaStatusMutation) OldCredentialID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCredentialID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
func (m *ProviderQuotaStatusMutation) ClearCredentialID() {
	m.credential = nil
	m.clearedFields[providerquotastatus.FieldCredentialID] = struct{}{}
}

// CredentialIDCleared returns if the "credential_id" field was cleared in this mutation.
func (m *ProviderQuotaStatusMutation) CredentialIDCleared() bool {
	_, ok := m.clearedFields[providerquotastatus.FieldCredentialID]
	return ok
}

// ResetCredentialID resets all changes to the "credential_id" field.
func (m *ProviderQuotaStatusMutation) ResetCredentialID() {
	m.credential = nil
	delete(m.clearedFields, providerquotastatus.FieldCredentialID)
}

// SetCredentialFingerprint sets the "credential_fingerprint" field.
func (m *ProviderQuotaStatusMutation) SetCredentialFingerprint(s string) {
	m.credential_fingerprint = &s
}

// CredentialFingerprint returns the value of the "credential_fingerprint" field in the mutation.
func (m *ProviderQuotaStatusMutation) CredentialFingerprint() (r string, exists bool) {
...
// OldCredentialFingerprint returns the old "credential_fingerprint" field's value of the ProviderQuotaStatus entity.
// If the ProviderQuotaStatus object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ProviderQuotaStatusMutation) OldCredentialFingerprint(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ProviderQuotaStatusMutation) ClearCredentialFingerprint() {
	m.credential_fingerprint = nil
	m.clearedFields[providerquotastatus.FieldCredentialFingerprint] = struct{}{}
}

// CredentialFingerprintCleared returns if the "credential_fingerprint" field was cleared in this mutation.
func (m *ProviderQuotaStatusMutation) CredentialFingerprintCleared() bool {
	_, ok := m.clearedFields[providerquotastatus.FieldCredentialFingerprint]
	return ok
}
...
// ClearCredential clears the "credential" edge to the UpstreamCredential entity.
func (m *ProviderQuotaStatusMutation) ClearCredential() {
	m.clearedcredential = true
	m.clearedFields[providerquotastatus.FieldCredentialID] = struct{}{}
}

// CredentialCleared reports if the "credential" edge to the UpstreamCredential entity was cleared.
func (m *ProviderQuotaStatusMutation) CredentialCleared() bool {
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// CredentialID instead. It exists only for internal usage by the builders.
func (m *ProviderQuotaStatusMutation) CredentialIDs() (ids []int) {
	if id := m.credential; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetCredential resets all changes to the "credential" edge.
func (m *ProviderQuotaStatusMutation) ResetCredential() {
	m.credential = nil
	m.clearedcredential = false
}
...
// SetCredentialID sets the "credential_id" field.
func (m *RequestExecutionMutation) SetCredentialID(i int) {
	m.credential = &i
}

// CredentialID returns the value of the "credential_id" field in the mutation.
func (m *RequestExecutionMutation) CredentialID() (r int, exists bool) {
	v := m.credential
	if v == nil {
		return
	}
...
// OldCredentialID returns the old "credential_id" field's value of the RequestExecution entity.
// If the RequestExecution object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RequestExecutionMutation) OldCredentialID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCredentialID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearCredentialID clears the value of the "credential_id" field.
func (m *RequestExecutionMutation) ClearCredentialID() {
	m.credential = nil
	m.clearedFields[requestexecution.FieldCredentialID] = struct{}{}
}

// CredentialIDCleared returns if the "credential_id" field was cleared in this mutation.
func (m *RequestExecutionMutation) CredentialIDCleared() bool {
	_, ok := m.clearedFields[requestexecution.FieldCredentialID]
	return ok
}

// ResetCredentialID resets all changes to the "credential_id" field.
func (m *RequestExecutionMutation) ResetCredentialID() {
	m.credential = nil
	delete(m.clearedFields, requestexecution.FieldCredentialID)
}
...
// SetCredentialFingerprint sets the "credential_fingerprint" field.
func (m *RequestExecutionMutation) SetCredentialFingerprint(s string) {
	m.credential_fingerprint = &s
}

// CredentialFingerprint returns the value of the "credential_fingerprint" field in the mutation.
func (m *RequestExecutionMutation) CredentialFingerprint() (r string, exists bool) {
	v := m.credential_fingerprint
	if v == nil {
		return
	}
...
// OldCredentialFingerprint returns the old "credential_fingerprint" field's value of the RequestExecution entity.
// If the RequestExecution object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RequestExecutionMutation) OldCredentialFingerprint(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCredentialFingerprint is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearCredentialFingerprint clears the value of the "credential_fingerprint" field.
func (m *RequestExecutionMutation) ClearCredentialFingerprint() {
	m.credential_fingerprint = nil
	m.clearedFields[requestexecution.FieldCredentialFingerprint] = struct{}{}
}

// CredentialFingerprintCleared returns if the "credential_fingerprint" field was cleared in this mutation.
func (m *RequestExecutionMutation) CredentialFingerprintCleared() bool {
	_, ok := m.clearedFields[requestexecution.FieldCredentialFingerprint]
	return ok
}
...
// ClearCredential clears the "credential" edge to the UpstreamCredential entity.
func (m *RequestExecutionMutation) ClearCredential() {
	m.clearedcredential = true
	m.clearedFields[requestexecution.FieldCredentialID] = struct{}{}
}

// CredentialCleared reports if the "credential" edge to the UpstreamCredential entity was cleared.
func (m *RequestExecutionMutation) CredentialCleared() bool {
	return m.CredentialIDCleared() || m.clearedcredential
}
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// CredentialID instead. It exists only for internal usage by the builders.
func (m *RequestExecutionMutation) CredentialIDs() (ids []int) {
	if id := m.credential; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetCredential resets all changes to the "credential" edge.
func (m *RequestExecutionMutation) ResetCredential() {
	m.credential = nil
	m.clearedcredential = false
}
...
func (m *RequestExecutionMutation) Fields() []string {
	...
	if m.credential != nil {
		fields = append(fields, requestexecution.FieldCredentialID)
	}
	if m.data_storage != nil {
...
func (m *RequestExecutionMutation) ClearedFields() []string {
	...
	if m.FieldCleared(requestexecution.FieldCredentialID) {
		fields = append(fields, requestexecution.FieldCredentialID)
	}
...
// UpstreamCredentialMutation represents an operation that mutates the UpstreamCredential nodes in the graph.
type UpstreamCredentialMutation struct {
	config
	op                             Op
	typ                            string
	id                             *int
	...
	removedchannel_refs            map[int]struct{}
	clearedchannel_refs            bool
	executions                     map[int]struct{}
	removedexecutions              map[int]struct{}
	clearedexecutions              bool
	usage_logs                     map[int]struct{}
...
var _ ent.Mutation = (*UpstreamCredentialMutation)(nil)

// upstreamcredentialOption allows management of the mutation configuration using functional options.
type upstreamcredentialOption func(*UpstreamCredentialMutation)

// newUpstreamCredentialMutation creates new mutation for the UpstreamCredential entity.
func newUpstreamCredentialMutation(c config, op Op, opts ...upstreamcredentialOption) *UpstreamCredentialMutation {
	m := &UpstreamCredentialMutation{
		config:        c,
		op:            op,
		typ:           TypeUpstreamCredential,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withUpstreamCredentialID sets the ID field of the mutation.
func withUpstreamCredentialID(id int) upstreamcredentialOption {
	return func(m *UpstreamCredentialMutation) {
		var (
			err   error
			once  sync.Once
			value *UpstreamCredential
		)
		m.oldValue = func(ctx context.Context) (*UpstreamCredential, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().UpstreamCredential.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withUpstreamCredential sets the old UpstreamCredential of the mutation.
func withUpstreamCredential(node *UpstreamCredential) upstreamcredentialOption {
	return func(m *UpstreamCredentialMutation) {
		m.oldValue = func(context.Context) (*UpstreamCredential, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m UpstreamCredentialMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m UpstreamCredentialMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *UpstreamCredentialMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *UpstreamCredentialMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().UpstreamCredential.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetCreatedAt sets the "created_at" field.
func (m *UpstreamCredentialMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *UpstreamCredentialMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the UpstreamCredential entity.
// If the UpstreamCredential object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UpstreamCredentialMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *UpstreamCredentialMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *UpstreamCredentialMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *UpstreamCredentialMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the UpstreamCredential entity.
// If the UpstreamCredential object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UpstreamCredentialMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *UpstreamCredentialMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// SetDeletedAt sets the "deleted_at" field.
func (m *UpstreamCredentialMutation) SetDeletedAt(i int) {
	m.deleted_at = &i
	m.adddeleted_at = nil
}

// DeletedAt returns the value of the "deleted_at" field in the mutation.
func (m *UpstreamCredentialMutation) DeletedAt() (r int, exists bool) {
	v := m.deleted_at
	if v == nil {
		return
	}
...
// OldDeletedAt returns the old "deleted_at" field's value of the UpstreamCredential entity.
// If the UpstreamCredential object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UpstreamCredentialMutation) OldDeletedAt(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDeletedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddDeletedAt adds i to the "deleted_at" field.
func (m *UpstreamCredentialMutation) AddDeletedAt(i int) {
	if m.adddeleted_at != nil {
		*m.adddeleted_at += i
	} else {
		m.adddeleted_at = &i
...
// AddedDeletedAt returns the value that was added to the "deleted_at" field in this mutation.
func (m *UpstreamCredentialMutation) AddedDeletedAt() (r int, exists bool) {
	v := m.adddeleted_at
	if v == nil {
		return
	}
...
// ResetDeletedAt resets all changes to the "deleted_at" field.
func (m *UpstreamCredentialMutation) ResetDeletedAt() {
	m.deleted_at = nil
	m.adddeleted_at = nil
}

// SetName sets the "name" field.
func (m *UpstreamCredentialMutation) SetName(s string) {
	m.name = &s
}

// Name returns the value of the "name" field in the mutation.
func (m *UpstreamCredentialMutation) Name() (r string, exists bool) {
	v := m.name
	if v == nil {
		return
	}
...
// OldName returns the old "name" field's value of the UpstreamCredential entity.
// If the UpstreamCredential object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UpstreamCredentialMutation) OldName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldName is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
func (m *UpstreamCredentialMutation) ClearName() {
	m.name = nil
	m.clearedFields[upstreamcredential.FieldName] = struct{}{}
}

// NameCleared returns if the "name" field was cleared in this mutation.
func (m *UpstreamCredentialMutation) NameCleared() bool {
	_, ok := m.clearedFields[upstreamcredential.FieldName]
	return ok
}

// ResetName resets all changes to the "name" field.
func (m *UpstreamCredentialMutation) ResetName() {
	m.name = nil
	delete(m.clearedFields, upstreamcredential.FieldName)
}

// SetProviderType sets the "provider_type" field.
func (m *UpstreamCredentialMutation) SetProviderType(s string) {
	m.provider_type = &s
}

// ProviderType returns the value of the "provider_type" field in the mutation.
func (m *UpstreamCredentialMutation) ProviderType() (r string, exists bool) {
	v := m.provider_type
	if v == nil {
		return
	}
...
// OldProviderType returns the old "provider_type" field's value of the UpstreamCredential entity.
// If the UpstreamCredential object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UpstreamCredentialMutation) OldProviderType(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldProviderType is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetProviderType resets all changes to the "provider_type" field.
func (m *UpstreamCredentialMutation) ResetProviderType() {
	m.provider_type = nil
}

// SetBaseURL sets the "base_url" field.
func (m *UpstreamCredentialMutation) SetBaseURL(s string) {
	m.base_url = &s
}

// BaseURL returns the value of the "base_url" field in the mutation.
func (m *UpstreamCredentialMutation) BaseURL() (r string, exists bool) {
	v := m.base_url
	if v == nil {
		return
	}
...
// OldBaseURL returns the old "base_url" field's value of the UpstreamCredential entity.
// If the UpstreamCredential object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UpstreamCredentialMutation) OldBaseURL(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldBaseURL is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearBaseURL clears the value of the "base_url" field.
func (m *UpstreamCredentialMutation) ClearBaseURL() {
	m.base_url = nil
	m.clearedFields[upstreamcredential.FieldBaseURL] = struct{}{}
}

// BaseURLCleared returns if the "base_url" field was cleared in this mutation.
func (m *UpstreamCredentialMutation) BaseURLCleared() bool {
	_, ok := m.clearedFields[upstreamcredential.FieldBaseURL]
	return ok
}

// ResetBaseURL resets all changes to the "base_url" field.
func (m *UpstreamCredentialMutation) ResetBaseURL() {
	m.base_url = nil
	delete(m.clearedFields, upstreamcredential.FieldBaseURL)
}

// SetAuthKind sets the "auth_kind" field.
func (m *UpstreamCredentialMutation) SetAuthKind(uk upstreamcredential.AuthKind) {
	m.auth_kind = &uk
}

// AuthKind returns the value of the "auth_kind" field in the mutation.
func (m *UpstreamCredentialMutation) AuthKind() (r upstreamcredential.AuthKind, exists bool) {
	v := m.auth_kind
	if v == nil {
		return
	}
...
// OldAuthKind returns the old "auth_kind" field's value of the UpstreamCredential entity.
// If the UpstreamCredential object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UpstreamCredentialMutation) OldAuthKind(ctx context.Context) (v upstreamcredential.AuthKind, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldAuthKind is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldAuthKind requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldAuthKind: %w", err)
	}
	return oldValue.AuthKind, nil
}

// ResetAuthKind resets all changes to the "auth_kind" field.
func (m *UpstreamCredentialMutation) ResetAuthKind() {
	m.auth_kind = nil
}
...
// SecretPayload returns the value of the "secret_payload" field in the mutation.
func (m *UpstreamCredentialMutation) SecretPayload() (r objects.UpstreamCredentialSecret, exists bool) {
	v := m.secret_payload
	if v == nil {
		return
	}
...
// OldSecretPayload returns the old "secret_payload" field's value of the UpstreamCredential entity.
// If the UpstreamCredential object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UpstreamCredentialMutation) OldSecretPayload(ctx context.Context) (v objects.UpstreamCredentialSecret, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSecretPayload is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldSecretPayload requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldSecretPayload: %w", err)
	}
	return oldValue.SecretPayload, nil
}

// ResetSecretPayload resets all changes to the "secret_payload" field.
func (m *UpstreamCredentialMutation) ResetSecretPayload() {
	m.secret_payload = nil
}

// SetFingerprint sets the "fingerprint" field.
func (m *UpstreamCredentialMutation) SetFingerprint(s string) {
	m.fingerprint = &s
}

// Fingerprint returns the value of the "fingerprint" field in the mutation.
func (m *UpstreamCredentialMutation) Fingerprint() (r string, exists bool) {
	v := m.fingerprint
	if v == nil {
		return
	}
...
// OldFingerprint returns the old "fingerprint" field's value of the UpstreamCredential entity.
// If the UpstreamCredential object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UpstreamCredentialMutation) OldFingerprint(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
// SetStatus sets the "status" field.
func (m *UpstreamCredentialMutation) SetStatus(u upstreamcredential.Status) {
	m.status = &u
}

// Status returns the value of the "status" field in the mutation.
func (m *UpstreamCredentialMutation) Status() (r upstreamcredential.Status, exists bool) {
	v := m.status
	if v == nil {
		return
	}
...
// OldStatus returns the old "status" field's value of the UpstreamCredential entity.
// If the UpstreamCredential object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UpstreamCredentialMutation) OldStatus(ctx context.Context) (v upstreamcredential.Status, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldStatus is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetStatus resets all changes to the "status" field.
func (m *UpstreamCredentialMutation) ResetStatus() {
	m.status = nil
}

// SetWeight sets the "weight" field.
func (m *UpstreamCredentialMutation) SetWeight(i int) {
	m.weight = &i
	m.addweight = nil
}

// Weight returns the value of the "weight" field in the mutation.
func (m *UpstreamCredentialMutation) Weight() (r int, exists bool) {
	v := m.weight
	if v == nil {
		return
	}
...
// OldWeight returns the old "weight" field's value of the UpstreamCredential entity.
// If the UpstreamCredential object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UpstreamCredentialMutation) OldWeight(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UpstreamCredentialMutation) AddWeight(i int) {
	if m.addweight != nil {
		*m.addweight += i
	} else {
		m.addweight = &i
...
func (m *UpstreamCredentialMutation) AddedWeight() (r int, exists bool) {
	v := m.addweight
	if v == nil {
		return
	}
...
// SetRemark sets the "remark" field.
func (m *UpstreamCredentialMutation) SetRemark(s string) {
	m.remark = &s
}

// Remark returns the value of the "remark" field in the mutation.
func (m *UpstreamCredentialMutation) Remark() (r string, exists bool) {
	v := m.remark
	if v == nil {
		return
	}
...
// OldRemark returns the old "remark" field's value of the UpstreamCredential entity.
// If the UpstreamCredential object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UpstreamCredentialMutation) OldRemark(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldRemark is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearRemark clears the value of the "remark" field.
func (m *UpstreamCredentialMutation) ClearRemark() {
	m.remark = nil
	m.clearedFields[upstreamcredential.FieldRemark] = struct{}{}
}

// RemarkCleared returns if the "remark" field was cleared in this mutation.
func (m *UpstreamCredentialMutation) RemarkCleared() bool {
	_, ok := m.clearedFields[upstreamcredential.FieldRemark]
	return ok
}

// ResetRemark resets all changes to the "remark" field.
func (m *UpstreamCredentialMutation) ResetRemark() {
	m.remark = nil
	delete(m.clearedFields, upstreamcredential.FieldRemark)
}

// AddChannelRefIDs adds the "channel_refs" edge to the ChannelCredentialRef entity by ids.
func (m *UpstreamCredentialMutation) AddChannelRefIDs(ids ...int) {
	if m.channel_refs == nil {
		m.channel_refs = make(map[int]struct{})
	}
	for i := range ids {
		m.channel_refs[ids[i]] = struct{}{}
	}
}

// ClearChannelRefs clears the "channel_refs" edge to the ChannelCredentialRef entity.
func (m *UpstreamCredentialMutation) ClearChannelRefs() {
	m.clearedchannel_refs = true
}

// ChannelRefsCleared reports if the "channel_refs" edge to the ChannelCredentialRef entity was cleared.
func (m *UpstreamCredentialMutation) ChannelRefsCleared() bool {
	return m.clearedchannel_refs
}

// RemoveChannelRefIDs removes the "channel_refs" edge to the ChannelCredentialRef entity by IDs.
func (m *UpstreamCredentialMutation) RemoveChannelRefIDs(ids ...int) {
	if m.removedchannel_refs == nil {
		m.removedchannel_refs = make(map[int]struct{})
	}
	for i := range ids {
		delete(m.channel_refs, ids[i])
		m.removedchannel_refs[ids[i]] = struct{}{}
	}
}

// RemovedChannelRefs returns the removed IDs of the "channel_refs" edge to the ChannelCredentialRef entity.
func (m *UpstreamCredentialMutation) RemovedChannelRefsIDs() (ids []int) {
	for id := range m.removedchannel_refs {
		ids = append(ids, id)
	}
	return
}

// ChannelRefsIDs returns the "channel_refs" edge IDs in the mutation.
func (m *UpstreamCredentialMutation) ChannelRefsIDs() (ids []int) {
	for id := range m.channel_refs {
		ids = append(ids, id)
	}
	return
}

// ResetChannelRefs resets all changes to the "channel_refs" edge.
func (m *UpstreamCredentialMutation) ResetChannelRefs() {
	m.channel_refs = nil
	m.clearedchannel_refs = false
	m.removedchannel_refs = nil
}

// AddExecutionIDs adds the "executions" edge to the RequestExecution entity by ids.
func (m *UpstreamCredentialMutation) AddExecutionIDs(ids ...int) {
	if m.executions == nil {
		m.executions = make(map[int]struct{})
	}
	for i := range ids {
...
// ClearExecutions clears the "executions" edge to the RequestExecution entity.
func (m *UpstreamCredentialMutation) ClearExecutions() {
	m.clearedexecutions = true
}

// ExecutionsCleared reports if the "executions" edge to the RequestExecution entity was cleared.
func (m *UpstreamCredentialMutation) ExecutionsCleared() bool {
	return m.clearedexecutions
}

// RemoveExecutionIDs removes the "executions" edge to the RequestExecution entity by IDs.
func (m *UpstreamCredentialMutation) RemoveExecutionIDs(ids ...int) {
	if m.removedexecutions == nil {
		m.removedexecutions = make(map[int]struct{})
	}
	for i := range ids {
...
// RemovedExecutions returns the removed IDs of the "executions" edge to the RequestExecution entity.
func (m *UpstreamCredentialMutation) RemovedExecutionsIDs() (ids []int) {
	for id := range m.removedexecutions {
		ids = append(ids, id)
	}
	return
...
// ExecutionsIDs returns the "executions" edge IDs in the mutation.
func (m *UpstreamCredentialMutation) ExecutionsIDs() (ids []int) {
	for id := range m.executions {
		ids = append(ids, id)
	}
	return
...
// ResetExecutions resets all changes to the "executions" edge.
func (m *UpstreamCredentialMutation) ResetExecutions() {
	m.executions = nil
	m.clearedexecutions = false
	m.removedexecutions = nil
}
...
// AddUsageLogIDs adds the "usage_logs" edge to the UsageLog entity by ids.
func (m *UpstreamCredentialMutation) AddUsageLogIDs(ids ...int) {
	if m.usage_logs == nil {
		m.usage_logs = make(map[int]struct{})
	}
	for i := range ids {
...
// ClearUsageLogs clears the "usage_logs" edge to the UsageLog entity.
func (m *UpstreamCredentialMutation) ClearUsageLogs() {
	m.clearedusage_logs = true
}

// UsageLogsCleared reports if the "usage_logs" edge to the UsageLog entity was cleared.
func (m *UpstreamCredentialMutation) UsageLogsCleared() bool {
	return m.clearedusage_logs
}

// RemoveUsageLogIDs removes the "usage_logs" edge to the UsageLog entity by IDs.
func (m *UpstreamCredentialMutation) RemoveUsageLogIDs(ids ...int) {
	if m.removedusage_logs == nil {
		m.removedusage_logs = make(map[int]struct{})
	}
	for i := range ids {
...
// RemovedUsageLogs returns the removed IDs of the "usage_logs" edge to the UsageLog entity.
func (m *UpstreamCredentialMutation) RemovedUsageLogsIDs() (ids []int) {
	for id := range m.removedusage_logs {
		ids = append(ids, id)
	}
	return
...
// UsageLogsIDs returns the "usage_logs" edge IDs in the mutation.
func (m *UpstreamCredentialMutation) UsageLogsIDs() (ids []int) {
	for id := range m.usage_logs {
		ids = append(ids, id)
	}
	return
...
// ResetUsageLogs resets all changes to the "usage_logs" edge.
func (m *UpstreamCredentialMutation) ResetUsageLogs() {
	m.usage_logs = nil
	m.clearedusage_logs = false
	m.removedusage_logs = nil
}
...
func (m *UpstreamCredentialMutation) AddProviderQuotaStatusIDs(ids ...int) {
...
func (m *UpstreamCredentialMutation) ClearProviderQuotaStatuses() {
...
func (m *UpstreamCredentialMutation) ProviderQuotaStatusesCleared() bool {
...
func (m *UpstreamCredentialMutation) RemoveProviderQuotaStatusIDs(ids ...int) {
...
func (m *UpstreamCredentialMutation) RemovedProviderQuotaStatusesIDs() (ids []int) {
...
func (m *UpstreamCredentialMutation) ProviderQuotaStatusesIDs() (ids []int) {
...
func (m *UpstreamCredentialMutation) ResetProviderQuotaStatuses() {
...
// WhereP appends storage-level predicates to the UpstreamCredentialMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *UpstreamCredentialMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.UpstreamCredential, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *UpstreamCredentialMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *UpstreamCredentialMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (UpstreamCredential).
func (m *UpstreamCredentialMutation) Type() string {
	return m.typ
}
...
func (m *UpstreamCredentialMutation) Fields() []string {
	...
	if m.updated_at != nil {
		fields = append(fields, upstreamcredential.FieldUpdatedAt)
	}
	if m.deleted_at != nil {
		fields = append(fields, upstreamcredential.FieldDeletedAt)
	}
	if m.name != nil {
		fields = append(fields, upstreamcredential.FieldName)
	}
	if m.provider_type != nil {
		fields = append(fields, upstreamcredential.FieldProviderType)
	}
	if m.base_url != nil {
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *UpstreamCredentialMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *UpstreamCredentialMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case upstreamcredential.FieldCreatedAt:
		return m.OldCreatedAt(ctx)
	case upstreamcredential.FieldUpdatedAt:
	...
	return nil, fmt.Errorf("unknown UpstreamCredential field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *UpstreamCredentialMutation) SetField(name string, value ent.Value) error {
	switch name {
	case upstreamcredential.FieldCreatedAt:
		v, ok := value.(time.Time)
		if !ok {
	...
	case upstreamcredential.FieldBaseURL:
		...
		return nil
	case upstreamcredential.FieldAuthKind:
		v, ok := value.(upstreamcredential.AuthKind)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
		m.SetAuthKind(v)
	...
	return fmt.Errorf("unknown UpstreamCredential field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *UpstreamCredentialMutation) AddedFields() []string {
	var fields []string
	if m.adddeleted_at != nil {
		fields = append(fields, upstreamcredential.FieldDeletedAt)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *UpstreamCredentialMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case upstreamcredential.FieldDeletedAt:
		return m.AddedDeletedAt()
	case upstreamcredential.FieldWeight:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *UpstreamCredentialMutation) AddField(name string, value ent.Value) error {
	switch name {
	case upstreamcredential.FieldDeletedAt:
		v, ok := value.(int)
		if !ok {
	...
	return fmt.Errorf("unknown UpstreamCredential numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *UpstreamCredentialMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(upstreamcredential.FieldName) {
		fields = append(fields, upstreamcredential.FieldName)
	}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *UpstreamCredentialMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *UpstreamCredentialMutation) ClearField(name string) error {
	switch name {
	case upstreamcredential.FieldName:
		m.ClearName()
		return nil
	...
	return fmt.Errorf("unknown UpstreamCredential nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *UpstreamCredentialMutation) ResetField(name string) error {
	switch name {
	case upstreamcredential.FieldCreatedAt:
		m.ResetCreatedAt()
		return nil
...
func (m *UpstreamCredentialMutation) AddedEdges() []string {
	...
	if m.executions != nil {
		edges = append(edges, upstreamcredential.EdgeExecutions)
	}
	if m.usage_logs != nil {
		edges = append(edges, upstreamcredential.EdgeUsageLogs)
	}
	if m.provider_quota_statuses != nil {
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *UpstreamCredentialMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case upstreamcredential.EdgeChannelRefs:
		ids := make([]ent.Value, 0, len(m.channel_refs))
		for id := range m.channel_refs {
			ids = append(ids, id)
		}
		return ids
	case upstreamcredential.EdgeExecutions:
		ids := make([]ent.Value, 0, len(m.executions))
		for id := range m.executions {
			ids = append(ids, id)
		}
		return ids
	case upstreamcredential.EdgeUsageLogs:
		ids := make([]ent.Value, 0, len(m.usage_logs))
		for id := range m.usage_logs {
			ids = append(ids, id)
		}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *UpstreamCredentialMutation) RemovedIDs(name string) []ent.Value {
	switch name {
	case upstreamcredential.EdgeChannelRefs:
		ids := make([]ent.Value, 0, len(m.removedchannel_refs))
		for id := range m.removedchannel_refs {
			ids = append(ids, id)
		}
		return ids
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *UpstreamCredentialMutation) EdgeCleared(name string) bool {
	switch name {
	case upstreamcredential.EdgeChannelRefs:
		return m.clearedchannel_refs
	case upstreamcredential.EdgeExecutions:
...
// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *UpstreamCredentialMutation) ResetEdge(name string) error {
	switch name {
	case upstreamcredential.EdgeChannelRefs:
		m.ResetChannelRefs()
		return nil
...
// SetCredentialID sets the "credential_id" field.
func (m *UsageLogMutation) SetCredentialID(i int) {
	m.credential = &i
}

// CredentialID returns the value of the "credential_id" field in the mutation.
func (m *UsageLogMutation) CredentialID() (r int, exists bool) {
	v := m.credential
	if v == nil {
		return
	}
...
// OldCredentialID returns the old "credential_id" field's value of the UsageLog entity.
// If the UsageLog object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UsageLogMutation) OldCredentialID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCredentialID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearCredentialID clears the value of the "credential_id" field.
func (m *UsageLogMutation) ClearCredentialID() {
	m.credential = nil
	m.clearedFields[usagelog.FieldCredentialID] = struct{}{}
}

// CredentialIDCleared returns if the "credential_id" field was cleared in this mutation.
func (m *UsageLogMutation) CredentialIDCleared() bool {
	_, ok := m.clearedFields[usagelog.FieldCredentialID]
	return ok
}

// ResetCredentialID resets all changes to the "credential_id" field.
func (m *UsageLogMutation) ResetCredentialID() {
	m.credential = nil
	delete(m.clearedFields, usagelog.FieldCredentialID)
}
...
// SetCredentialFingerprint sets the "credential_fingerprint" field.
func (m *UsageLogMutation) SetCredentialFingerprint(s string) {
	m.credential_fingerprint = &s
}

// CredentialFingerprint returns the value of the "credential_fingerprint" field in the mutation.
func (m *UsageLogMutation) CredentialFingerprint() (r string, exists bool) {
	v := m.credential_fingerprint
	if v == nil {
		return
	}
...
// OldCredentialFingerprint returns the old "credential_fingerprint" field's value of the UsageLog entity.
// If the UsageLog object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UsageLogMutation) OldCredentialFingerprint(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCredentialFingerprint is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearCredentialFingerprint clears the value of the "credential_fingerprint" field.
func (m *UsageLogMutation) ClearCredentialFingerprint() {
	m.credential_fingerprint = nil
	m.clearedFields[usagelog.FieldCredentialFingerprint] = struct{}{}
}

// CredentialFingerprintCleared returns if the "credential_fingerprint" field was cleared in this mutation.
func (m *UsageLogMutation) CredentialFingerprintCleared() bool {
	_, ok := m.clearedFields[usagelog.FieldCredentialFingerprint]
	return ok
}
...
// ClearCredential clears the "credential" edge to the UpstreamCredential entity.
func (m *UsageLogMutation) ClearCredential() {
	m.clearedcredential = true
	m.clearedFields[usagelog.FieldCredentialID] = struct{}{}
}

// CredentialCleared reports if the "credential" edge to the UpstreamCredential entity was cleared.
func (m *UsageLogMutation) CredentialCleared() bool {
	return m.CredentialIDCleared() || m.clearedcredential
}
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// CredentialID instead. It exists only for internal usage by the builders.
func (m *UsageLogMutation) CredentialIDs() (ids []int) {
	if id := m.credential; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetCredential resets all changes to the "credential" edge.
func (m *UsageLogMutation) ResetCredential() {
	m.credential = nil
	m.clearedcredential = false
}
...
func (m *UsageLogMutation) Fields() []string {
	...
	if m.credential != nil {
		fields = append(fields, usagelog.FieldCredentialID)
	}
	if m.model_id != nil {
...
func (m *UsageLogMutation) ClearedFields() []string {
	...
	if m.FieldCleared(usagelog.FieldCredentialID) {
		fields = append(fields, usagelog.FieldCredentialID)
	}
