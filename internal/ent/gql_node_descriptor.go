...
func (_m *Channel) Node(ctx context.Context) (node *Node, err error) {
	...
	err = _m.QueryCredentialRefs().
		Select(channelcredentialref.FieldID).
	...
	node.Edges[6] = &Edge{
		...
		Name: "provider_quota_statuses",
	}
	err = _m.QueryProviderQuotaStatuses().
...
// Node implements Noder interface
func (_m *ChannelCredentialRef) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     _m.ID,
		Type:   "ChannelCredentialRef",
		Fields: make([]*Field, 5),
	...
	if buf, err = json.Marshal(_m.CredentialID); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "int",
	...
	err = _m.QueryCredential().
		Select(upstreamcredential.FieldID).
		Scan(ctx, &node.Edges[1].IDs)
	if err != nil {
		return nil, err
	}
...
// Node implements Noder interface
func (_m *CredentialQuotaScope) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     _m.ID,
	...
	node.Fields[3] = &Field{
		Type:  "credentialquotascope.Status",
		Name:  "status",
		Value: string(buf),
	}
	...
	node.Fields[4] = &Field{
		Type:  "credentialquotascope.Unit",
		Name:  "unit",
		Value: string(buf),
	}
	if buf, err = json.Marshal(_m.LimitAmount); err != nil {
		return nil, err
	}
	node.Fields[5] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(_m.UsedAmount); err != nil {
		return nil, err
	}
	node.Fields[6] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(_m.WarningThresholdPercent); err != nil {
		return nil, err
	}
	node.Fields[7] = &Field{
		Type:  "int",
	...
	if buf, err = json.Marshal(_m.ResetPolicy); err != nil {
		return nil, err
	}
	node.Fields[8] = &Field{
		Type:  "credentialquotascope.ResetPolicy",
		Name:  "reset_policy",
		Value: string(buf),
	}
	...
	if buf, err = json.Marshal(_m.WindowStartedAt); err != nil {
		return nil, err
	}
	node.Fields[10] = &Field{
		Type:  "time.Time",
	...
	if buf, err = json.Marshal(_m.OverLimitAction); err != nil {
		return nil, err
	}
	node.Fields[11] = &Field{
		Type:  "credentialquotascope.OverLimitAction",
		Name:  "over_limit_action",
		Value: string(buf),
	}
	if buf, err = json.Marshal(_m.PauseUntil); err != nil {
		return nil, err
	}
	node.Fields[12] = &Field{
		Type:  "time.Time",
	...
	node.Fields[13] = &Field{
		Type:  "credentialquotascope.Source",
		Name:  "source",
		Value: string(buf),
	}
...
func (_m *ProviderQuotaStatus) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(_m.ScopeKey); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(_m.SecretFingerprint); err != nil {
		return nil, err
	}
	node.Fields[6] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(_m.ResourceScopeKey); err != nil {
		return nil, err
	}
	node.Fields[7] = &Field{
		Type:  "string",
		Name:  "resource_scope_key",
		Value: string(buf),
	}
	...
	err = _m.QueryQuotaScope().
		Select(credentialquotascope.FieldID).
		Scan(ctx, &node.Edges[2].IDs)
	if err != nil {
		return nil, err
	}
...
func (_m *RequestExecution) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(_m.QuotaScopeNameSnapshot); err != nil {
		return nil, err
	}
	node.Fields[13] = &Field{
		Type:  "string",
		Name:  "quota_scope_name_snapshot",
		Value: string(buf),
	}
	if buf, err = json.Marshal(_m.QuotaScopeStatusSnapshot); err != nil {
		return nil, err
	}
	node.Fields[14] = &Field{
		Type:  "string",
		Name:  "quota_scope_status_snapshot",
		Value: string(buf),
	}
...
// Node implements Noder interface
func (_m *UpstreamCredential) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     _m.ID,
		Type:   "UpstreamCredential",
