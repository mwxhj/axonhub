...
const (
	// Label holds the string label denoting the channelcredentialref type in the database.
	Label = "channel_credential_ref"
	...
	// Table holds the table name of the channelcredentialref in the database.
	Table = "channel_credential_refs"
	// ChannelTable is the table that holds the channel relation/edge.
	ChannelTable = "channel_credential_refs"
	...
	CredentialTable = "channel_credential_refs"
...
// Columns holds all SQL columns for channelcredentialref fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the ChannelCredentialRef queries.
