...
func latestChannelCredentialUpdateTime(channel *ent.Channel, credential *ent.UpstreamCredential, ref *ent.ChannelCredentialRef, quotaScope *ent.CredentialQuotaScope) time.Time {
